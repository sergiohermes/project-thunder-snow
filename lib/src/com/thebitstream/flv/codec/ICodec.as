...
package com.thebitstream.flv.codec
{
	...
	{
		function get privateData():ByteArray;
		function get type():String;
		function get streamId():int;
		function set streamId(val:int):void
		function get flag():uint;
		function get flip():Boolean;
		function readTag(ba:ByteArray,streamTime:int):void;
		function readMetaObject(data:Object,streamTime:int):void;
